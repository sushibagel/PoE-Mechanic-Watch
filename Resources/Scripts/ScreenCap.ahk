...
Global RecapTran
Global RecapVolume ;notificationsettings.ahk globals

 RecapButtonNo() ;called in notificationsettings.ahk NotificationSettingsButtonClose()
     MiscIni := MiscIni()
...
;NotificationSettings.ahk gui entry
...
;NotificationSettings.ahk gui entry for controls
